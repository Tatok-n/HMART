...
def ask_user_with_gpt(question, conversation):
    ...
    try:
        ...
        user_reply = input(response["choices"][0]["message"]["content"].strip()) #chat gpt response is the string at the ask and user_reply is user input
...
probed_specs = [
    ...
    "driveTrain", "mktClass", "capacity", "mileage"
    ]
...
model_Choice = input("Do you want to use our car recommendation software or would you like to tell me what type of car you are looking for?")
choice_of_model = (f"From the user's input '{model_Choice}' I want you to determine what there answer to the question: "
...
if choice == 1: # if they wanna just describe what type of car they want
    user_spec = input("Describe what type of car you'd like: ")
    what_to_do = (f"I want you to look at the input '{user_spec}' from the user and make a list with the indices respecting this order:"
    ...
    print("There is a couple more information that I need before we can find you the right car. I will ask you some more questions to help filter the options ")
    for spec in unfound_specs:
        if spec in questions:
            ...
            summarize_answers = (f" I have a user input '{user_input}', to the question '{question}' I gave them freedom to write in any format they want"
